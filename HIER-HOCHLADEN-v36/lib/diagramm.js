 ...
 */
function sollIst({ titel, punkte, bisIndex = null, hoehe = 168, id = 'd1' }) {
  ...
  const b = Math.max(5, Math.min(20, proSpalte - 12));
 ...
 */
function abweichung({ titel, punkte, hoehe = 150, id = 'd2' }) {
 ...
 */
function ring({ titel, punkte, groesse = 190, id = 'd3' }) {
