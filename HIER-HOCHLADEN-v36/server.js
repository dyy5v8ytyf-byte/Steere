...
app.locals.terminAmpel = h.terminAmpel;
...
/*
 * Der Forecast gehoert fachlich unter Finanzen und hat dort seinen Platz in
 * der Reiterzeile. Er bleibt zusaetzlich unter /forecast erreichbar: Diese
 * Adresse steht in Lesezeichen und in aelteren Notizen, und ein toter Link
 * ist ein Aergernis, das sich mit einer Zeile vermeiden laesst.
 */
app.use('/finanzen/forecast', require('./routes/forecast'));
